...
# --- 0. PID FILE TO PREVENT MULTIPLE INSTANCES ---
...
def generate_professional_receipt(client_data, is_paid=False):
    try:
        ...
        draw.rectangle([(30, card_y), (width - 30, card_y + card_height)],
                       fill=(255, 255, 255, 240), outline=(255, 255, 255, 100), width=2)
        draw.rectangle([(40, card_y + 10), (width - 40, card_y + card_height - 10)],
                       fill=(240, 248, 255, 50))
        ...
        box_y = y
        box_height = 180
        draw.rectangle([(60, box_y), (width - 60, box_y + box_height)],
        ...
        billing_y = y
        billing_height = 200
        draw.rectangle([(60, billing_y), (width - 60, billing_y + billing_height)],
...
# ---------- THIS IS THE UPDATED VERIFY_CLIENT ----------
